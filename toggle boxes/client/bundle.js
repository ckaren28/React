	...
	var App = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { onClick: this.toggleAllBoxes },
	        'Toggle All Boxes'
	      ),
	      React.createElement(
	        'div',
	        null,
	        React.createElement(Box, { color: 'black', toggleAll: this.state.toggleAll }),
	        React.createElement(Box, { color: 'blue', toggleAll: this.state.toggleAll })
	      )
	    );
	  }
	});
	...
	var Box = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement('div', { className: displayClass + ' ' + this.props.color })
	    );
	  }
	});
